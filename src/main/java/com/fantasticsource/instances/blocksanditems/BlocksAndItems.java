...
import com.fantasticsource.instances.blocksanditems.blocks.BlockEntryPortal;
...
public class BlocksAndItems
{
    ...
    @GameRegistry.ObjectHolder("instances:entryportal")
    public static BlockEntryPortal blockEntryPortal;
    @GameRegistry.ObjectHolder("instances:entryportal")
    public static ItemEntryPortal itemEntryPortal;
    ...
    public static void blockRegistry(RegistryEvent.Register<Block> event)
    {
        ...
        registry.register(new BlockEntryPortal());

        GameRegistry.registerTileEntity(TEInstancePortal.class, "instances:instanceportal");
        GameRegistry.registerTileEntity(TEEntryPortal.class, "instances:entryportal");
    }
    ...
    public static void itemRegistry(RegistryEvent.Register<Item> event)
    {
        ...
        registry.register(new ItemEntryPortal());
    ...
    public static void modelRegistry(ModelRegistryEvent event)
    {
        ...
        ModelLoader.setCustomModelResourceLocation(itemEntryPortal, 0, new ModelResourceLocation("instances:entryportal", "inventory"));
